...
gcc -fpic -c mpeg42compressed/numpy/extract_mvs_wrap.c -o bin/extract_mvs_wrap.o -I/usr/include/python3.11  #TODO: Faire une commande bash qui recup tout seul le /usr/include/python avec la commande python3-config --cflags
